...
\lstinputlisting[language=cppp, caption={for-Loop für das Überprüfen aller Motoren, ob diese deren Rotation abgeschlossen haben und dadurch entschieden wird, ob die ganze Bewegung angehalten werden muss \label{lst:cpp_stop_move_for}}]{code/cpp/stop_move.cpp.txt}
\newpage
