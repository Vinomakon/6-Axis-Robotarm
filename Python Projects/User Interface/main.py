...
from inverse_kinematics import ik_calculate
...
def ik_movement(x_pos_: float, y_pos_: float, z_pos_: float, x_rot_: float, y_rot_: float, z_rot_: float,
    ...
    ik = ik_calculate(x_pos_, y_pos_, z_pos_, x_rot_, z_rot_, y_rot_, deg=True)
    mot_angle_ = (ik[0], ik[1], ik[2], x_rot_, y_rot_, z_rot_)
