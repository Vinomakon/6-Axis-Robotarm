...
if __name__ == "__main__":
    ...
    fk_control = ui_tabs.FKControl(tabs)
    fk_control.pack(fill="both", expand=1)
    ik_control = ui_tabs.IKControl(tabs)
    ik_control.pack(fill="both", expand=0)
    motor_control = ui_tabs.MotorControl(tabs)
    motor_control.pack(fill="both", expand=1)
    vepr_params = ui_tabs.VEPRParameters(tabs)
    vepr_params.pack(fill="both", expand=1)
    ui_config = ui_tabs.UIConfig(tabs)
